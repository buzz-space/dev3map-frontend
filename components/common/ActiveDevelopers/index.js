  ...
  return (
    <Container className={styles['container']}>
      <h2 className={clsx('title', styles['title'])}>
        Active Developers <Developer />
      </h2>
      <StatisListCard
        totalDev={data?.total_developer}
        totalFtDev={data?.total_full_time}
        totalMlDev={Number(data?.total_full_time) + Number(data?.total_part_time)}
      />
